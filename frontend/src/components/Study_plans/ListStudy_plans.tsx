...
const ListStudy_plans = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_STUDY_PLANS');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>StudyMaterials</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .study_materialsManyListFormatter(item.study_materials)
                        .join(', ')}
                    </p>
                  </div>
                </div>
...
export default ListStudy_plans;
